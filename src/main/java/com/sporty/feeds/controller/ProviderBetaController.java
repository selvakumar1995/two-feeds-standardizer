...
public class ProviderBetaController {
    ...
    public ProviderBetaController(NormalizationService normalizationService, InMemoryMessageBus bus) {
    ...
    public ResponseEntity<StandardMessage> receive(@RequestBody JsonNode payload) {
        StandardMessage msg = normalizationService.normalizeProviderBeta(payload);
        bus.send(msg);
